function [T_out,n_features_out,n_nodes_out] = STSFTrain(X_all_train, y_all_train, ntrees, agg_fns)
    ...
    for t = 1:ntrees
        ...
        for j = 1:total_candidate_agg_feats
            %ws = candidate_agg_feats{j}{1}; %%interval width
        ...
        tree = fitctree(X_2_train,y_train,'SplitCriterion','deviance'); %% train a tree with the interval feature representation
        ...
        n_nodes(end+1) = tree.NumNodes; %% to keep record of the number of nodes of the generated tree.
