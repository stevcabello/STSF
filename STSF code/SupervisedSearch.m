function [output] = SupervisedSearch(X,y,ini_idx,agg_fn,candidate_agg_feats,repr_type)
    ...
    if score_0 >= score_1
        ...
        [output] = SupervisedSearch(sub_interval_0, y, ini0, agg_fn, candidate_agg_feats,repr_type);
        ...
        [output] = SupervisedSearch(sub_interval_1, y, ini1, agg_fn, candidate_agg_feats,repr_type);
