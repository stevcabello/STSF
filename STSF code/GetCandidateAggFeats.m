function [all_candidate_agg_feats] = GetCandidateAggFeats(X,y,agg_fns,repr_type)
    ...
    random_cut_point = 4 + randperm(cols_X-8,1);%randperm(cols_X-1,1);%
    ...
    for i = 1:size(agg_fns,2)
            ...
            ini_L = 1;
            [cand_agg_feat_L] = BinarySearch(sub_ts_L,y,ini_L,agg_fns{i},{},repr_type);
            ...
            ini_R = idx_ts+1;
            [cand_agg_feat_R] = BinarySearch(sub_ts_R,y,ini_R,agg_fns{i},{},repr_type);
